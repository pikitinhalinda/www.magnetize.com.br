! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.AOS = t() : e.AOS = t() }(this, function() { return function(e) {
        ...
        t.default = n }]) });
jQuery(function($) { var a = window.navigator.userAgent; /MSIE|Trident/.test(a) ? ($("[data-aos^=zoom]").css("opacity", "1"), $("[data-aos^=zoom]").css("transform", "scale(1)"), $("[data-aos^=fade]").css("opacity", "1"), $("[data-aos^=fade]").css("transform", "scale(1)")) : AOS.init({ once: !0 }) });